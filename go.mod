module github.com/castillofranciscodaniel/golang-example
...
require (
	bitbucket.org/chattigodev/chattigo-golang-redis-library v1.0.1 // indirect
	bitbucket.org/chattigodev/chattigo-golang-security-library v1.1.0 // indirect
